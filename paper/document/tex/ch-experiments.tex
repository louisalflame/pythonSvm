...
\begin{figure}[ht]
	\graphicspath{{pic/}}
	\begin{center}
		\includegraphics[width=0.8\textwidth]{appDifficulty.png}
	\end{center}
...
\begin{figure}[ht]
	\graphicspath{{pic/}}
	\begin{center}
		\includegraphics[width=0.8\textwidth]{DynamicDifficulty1.png}
...
\begin{figure}[ht]
	\graphicspath{{pic/}}
	\begin{center}
		\includegraphics[width=0.5\textwidth]{DynamicDifficulty2.png}
...
\begin{figure}[ht]
	\graphicspath{{pic/}}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{DynamicDifficulty3.png}
